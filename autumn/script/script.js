...
const newPositionTop =  Math.random() * (window.innerHeight - 10); // Adjust the range as needed
const newPositionLeft = Math.random() * (window.innerWidth - 10); // Adjust the range as needed
